...
// Get all articles
$query = 'SELECT article.authorID, author.firstName, author.lastName, article.headline, article.body, article.publishDate, article.articleID
FROM author
    ...
    <div class="container" style="background-color: #FFFFFF;">
        ...
        <?php foreach ($article as $art) : ?>
            <div class="row">
                ...
                <div class="col-sm-8">
                    <form class="form" action="publish-article.php" method="post" id="publish-article-form">
                        <h5>
                            Author: <?php echo $art['firstName']; ?> <?php echo $art['lastName']; ?>
                        </h5>
                        <input type="hidden" name="authorID" value="<?php echo $art['authorID']; ?>">
                        <div class="form-group">
                            <label for="article">Headline</label>
                            <input class="form-control" type="text" name="headline">
                        </div>
                        <div class="form-group">
                            <label for="article">Date(XXXX/XX/XX)</label>
                            <input class="form-control" type="text" name="publishdate">
                        </div>
                        <div class="form-group">
                            <label for="article">Body</label>
                            <textarea class="form-control" rows="10" type="text" name="body"></textarea>
                        </div>
                        <input class="btn btn-info" type="submit" name="Add Article" value="Publish">
                    </form>
                </div>
                <div class="col-sm-2">&nbsp;</div>
            </div>
